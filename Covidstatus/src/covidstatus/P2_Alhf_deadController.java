...
import static covidstatus.P2_Alhf_ICUController.NUM;
import java.net.URL;
 ...
 * @author ahmed
 */
public class P2_Alhf_deadController implements Initializable {
Circle circle;
static int NUM=0;
    @FXML
   ...
   ArrayList <Human > Array = MAIN_loop.P2_R1_city3_DeadCitizen; 
