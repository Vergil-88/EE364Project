...
import static covidstatus.P2_Makkah_ICUController.NUM;
import java.net.URL;
 ...
 * @author ahmed
 */
public class P2_Makkah_deadController implements Initializable {
Circle circle;
static int NUM=0;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
                    ArrayList <Human > Array = MAIN_loop.P2_R2_city2_DeadCitizen; 
