...
import static covidstatus.Alhf_deadController.NUM;
import java.net.URL;
 ...
 * @author ahmed
 */
public class Alhf_travelController implements Initializable {
Circle circle;
static int NUM=0;
    ...
    public void initialize(URL url, ResourceBundle rb) {
                   ArrayList <Human > Array = MAIN_loop.R1_city3_Travel; 
