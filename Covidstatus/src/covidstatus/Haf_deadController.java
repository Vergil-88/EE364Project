...
import static covidstatus.Dam_deadController.NUM;
import java.net.URL;
 ...
 * @author ahmed
 */
public class Haf_deadController implements Initializable {
Circle circle;
static int NUM=0;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
                         ArrayList <Human > Array = MAIN_loop.R1_city1_DeadCitizen; 
