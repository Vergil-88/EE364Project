...
import static covidstatus.Madinah_ICUController.NUM;
import java.net.URL;
 ...
 * @author ahmed
 */
public class P2_Madinah_aliveController implements Initializable {
Circle circle;
static int NUM=0;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
                     ArrayList <Human > Array = MAIN_loop.P2_R2_city3_Citizen; 
