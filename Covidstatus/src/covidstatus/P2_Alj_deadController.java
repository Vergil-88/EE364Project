...
import static covidstatus.P2_Alj_ICUController.NUM;
import java.net.URL;
 ...
 * @author ahmed
 */
public class P2_Alj_deadController implements Initializable {
Circle circle;
static int NUM=0;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
               ArrayList <Human > Array = MAIN_loop.P2_R1_city2_DeadCitizen; 
